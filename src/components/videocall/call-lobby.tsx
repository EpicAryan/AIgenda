    ...
    return (
        <div className="flex flex-col items-center justify-center h-full bg-radial from-sidebar-accent to-sidebar">
            <div className="py-4 px-8 flex flex-1 items-center justify-center">
                <div className="flex flex-col items-center justify-center gap-y-6 bg-gray-400/40 rounded-lg p-10 shadow-sm">
                    <div className="flex flex-col gap-y-2 text-center text-gray-200">
                    ...
                    <div className="flex gap-x-2 justify-between w-full">
                        <Button asChild variant="ghost" className="text-gray-200 hover:text-black">
                            <Link href="/meetings">
                                Cancel
                            </Link>
                        </Button>
